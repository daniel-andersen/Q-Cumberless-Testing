...
public class CucumberDialog extends JFrame {
    public static CucumberEngine engine;
    public static JTextField elementTextField;
    public static JPanel mainPanel;

    public static CucumberDialog instance = null;

    private File fileChooserPath = null;

	public CucumberDialog() {
		super();
        instance = this;
        engine = new CucumberEngine();
		initComponents();
	}
	...
	private void initComponents() {
        ...
        elementTextField.addKeyListener(new KeyListener() {
            public void keyTyped(KeyEvent keyEvent) {
                CucumberEditBox.setText(elementTextField.getText());
            }
